...
export const MainSlider = () => {
	...
	return <div class="_s_lg-pl-2-5 _s_lg-pr-2-5">
		<div class="_s_position-relative _s_lg-mb-5 _s_lg-mt-5 _s_lg-overflow-hidden">
			<SwiperContainer autoplay={true} class="main-swiper _s_size-h-px--90 _s_lg-size-h-px--109 swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden ng-star-inserted">
				<For each={slides()}>
